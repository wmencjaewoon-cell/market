-- Ensure the store profile settings RPC matches the app payload exactly.
...
begin
  for v_function in
    ...
    where n.nspname = 'public'
      and p.proname = 'update_store_profile_settings'
  loop
...
create function public.update_store_profile_settings(
